...
#include <Library/I2cLib.h> //BLD_Charles_149+
//BLD_Charles_130+E
...
//BLD_Charles_130+S	
{
  ...
  CHIPSET_CONFIGURATION		    *mSystemConfiguration;
	...
	DEBUG ((EFI_D_INFO, "Charles InitializeI2cEnum start!\n"));
	...
	if (EFI_ERROR (Status)) {
	DEBUG ((EFI_D_INFO, "Charles InitializeI2cEnum GetVariable Fail!\n"));
	}
	DEBUG ((EFI_D_INFO, "Charles mSystemConfiguration->TouchSel: 0x%x!\n",mSystemConfiguration->TouchSel));			   
	 switch (mSystemConfiguration->TouchSel) {
		case 0x00:
			mSystemConfiguration->TouchSel = 0x01;
			break;
		case 0x01:
			mSystemConfiguration->TouchSel = 0x00;
			break;
		case 0x80:
			mSystemConfiguration->TouchSel = 0x00;
			break;
	...
	if(mSystemConfiguration->TouchSel == 0x01)
	{	
		DEBUG ((EFI_D_INFO, "Charles Not FT5526 ,Set ELAN!\n"));
		I2cDev->SlaveAddress                  = 0x10;
		I2cDev->I2cHidDevice.DescReg		  = 0x01;
		}
	...
	if (EFI_ERROR (Status)) {
	DEBUG ((EFI_D_INFO, "Charles InitializeI2cEnum SetVariable Fail!\n"));
			}
	DEBUG ((EFI_D_INFO, "Charles I2cDev->SlaveAddress 0x%x!\n",I2cDev->SlaveAddress));
	DEBUG ((EFI_D_INFO, "Charles I2cDev->I2cHidDevice.DescReg 0x%x!\n",I2cDev->I2cHidDevice.DescReg));
}	
//BLD_Charles_130+E	
*/
//BLD_Charles_149-e
//BLD_Charles_149+s
  ...
  CHIPSET_CONFIGURATION		    *mSystemConfiguration;
	...
	DEBUG ((EFI_D_INFO, "Charles InitializeI2cEnum GetVariable Fail!\n"));
		...
		Status = ByteReadI2C(5, 0x38, 0x00, 1, &value); //FT5526
		
		if (!EFI_ERROR (Status)) {
			DEBUG ((EFI_D_INFO, "Charles InitializeI2cEnum GetVariable Fail!\n"));
			I2cDev->SlaveAddress				  = 0x38;
			I2cDev->I2cHidDevice.DescReg		  = 0x00;
			mSystemConfiguration->TouchSel = 0x00;
		}
		
		Status = ByteReadI2C(5, 0x10, 0x00, 1, &value); //ELAN
