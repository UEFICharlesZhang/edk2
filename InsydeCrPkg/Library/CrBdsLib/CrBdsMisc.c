...
/**
 Check whether a give device path is a USB serial device
...
/**
 Check whether a give device path is a LAN serial device
  ...
  )
{
  ...
  PciDevPath = (PCI_DEVICE_PATH *)CRLocateDevicePathNode (&DevPath, HARDWARE_DEVICE_PATH, HW_PCCARD_DP);
