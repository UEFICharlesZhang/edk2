...
#define rotl32(x,n)   (UINT32)(UINTN)(((x) << n) | ((x) >> (32 - n)))
...
void SM3_process(SM3_STATE *md, CONST UINT8 *buf, UINTN len)
{
  while (len--){
    /* copy byte */
...
void SM3_done(SM3_STATE *md, UINT8 *hash)
{
  UINT32 i;
