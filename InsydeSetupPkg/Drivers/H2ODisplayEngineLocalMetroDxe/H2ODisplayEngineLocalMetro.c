  ...
  )
{
  ...
  for (Mode = 0; Mode < GraphicsOut->Mode->MaxMode; Mode++) {
    ...
    if ((Info->HorizontalResolution == (UINTN) PcdGet32 (PcdDisplayEngineLocalMetroHorizontalResolution)) &&
        (Info->VerticalResolution   == (UINTN) PcdGet32 (PcdDisplayEngineLocalMetroVerticalResolution))) {
