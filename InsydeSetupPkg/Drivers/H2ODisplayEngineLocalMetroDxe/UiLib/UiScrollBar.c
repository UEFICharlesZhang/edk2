...
CHAR16 *mScrollbarChilds = L""
  L"<Texture name='track' float='true' height='-1' width='-1' bkimage='@ScrollbarBackground' scale9grid='1,14,1,14'/>"
  L"<Texture name='thumb' float='true' pos='0,40,25,65' height='25' width='-1' bkimage='@ScrollbarThumb' scale9grid='1,13,1,13'/>";
