...
CHAR16 *mNumberPickerChilds = L""
  L"<VerticalLayout>"
    L"<Label visible='false' name='UpArrow' height='13'>"
      L"<Texture float='true' bkimage='@DialogButtonUp' bkcolor='0xFF333333' name='UpArrowImage' bkimagestyle='center'/>"
    L"</Label>"
    L"<HorizontalLayout name='PreviousValueLayout' height='52'>"
      L"<Label align='singleline|center' textcolor='0xFF808080' fontsize='29' bkcolor='0xFF333333' name='PreviousValue'/>"
    L"</HorizontalLayout>"
    L"<Label align='singleline|center' fontsize='29' bkcolor='0xFF787878' name='CurrentValue' height='39'/>"
    L"<HorizontalLayout name='NextValueLayout' height='52'>"
      L"<Label align='singleline|center' textcolor='0xFF808080' fontsize='29' bkcolor='0xFF333333' name='NextValue'/>"
    L"</HorizontalLayout>"
    L"<Label visible='true' name='DownArrow' height='13'>"
      L"<Texture float='true' bkimage='@DialogButtonDown' bkcolor='0xFF333333' name='DownArrowImage' bkimagestyle='center'/>"
    L"</Label>"
  L"</VerticalLayout>";
