...
CHAR16 *mSwitchChilds = L""
  L"<Label float='true' bkimage='@CheckBoxBorder' name='CheckboxBorder' scale9grid='14,1,14,1'/>"
  L"<Label float='true' padding='3,5,4,5' bkimage='@CheckBoxBkg' name='CheckboxBkg' scale9grid='14,1,14,1'/>"
  L"<Label textcolor='0xFFFFFFFF' float='true' fontsize='17' name='CheckboxText'/>"
  L"<HorizontalLayout float='true' name='CheckboxButton'>"
    L"<Label bkimage='@CheckBoxButton' scale9grid='11,1,11,1'/>"
  L"</HorizontalLayout>";
