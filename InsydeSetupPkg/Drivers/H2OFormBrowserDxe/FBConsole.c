  ...
  )
{
  ...
  if (Private->SetupMouse == NULL) {
    FBAddInputCheckEvent (Private, ConDev->Handle, ConDev, H2O_FORM_BROWSER_CONSOLE_SP);
    FBAddInputCheckEvent (Private, ConDev->Handle, ConDev, H2O_FORM_BROWSER_CONSOLE_AP);
  }
